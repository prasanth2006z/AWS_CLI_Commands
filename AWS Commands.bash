...
#Associate Egress-rule to Security Groups	

	aws ec2 authorize-security-group-egress --group-id sg-015dad3f98f66035e --protocol tcp --port 1521 --cidr 216.46.110.40/32

#Remove a Egress-rule from a security group
	aws ec2 revoke-security-group-egress --group-id sg-015dad3f98f66035e --protocol all --port all --cidr 0.0.0.0/0	
